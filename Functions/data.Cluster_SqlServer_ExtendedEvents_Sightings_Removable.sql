...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_ExtendedEvents_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_ExtendedEvents_Sightings].[SightingDate], [data].[Cluster_SqlServer_ExtendedEvents_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_ExtendedEvents_Sightings] ON [data].[Cluster_SqlServer_ExtendedEvents_Sightings].[Id] = [data].[Cluster_SqlServer_ExtendedEvents_Keys].[Id]

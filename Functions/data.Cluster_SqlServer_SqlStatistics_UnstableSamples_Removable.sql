...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_SqlStatistics_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_SqlStatistics_UnstableSamples] ON [data].[Cluster_SqlServer_SqlStatistics_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Keys].[Id]

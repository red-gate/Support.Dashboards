...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_VMware_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_VMware_UnstableSamples] ON [data].[Cluster_Machine_VMware_UnstableSamples].[Id] = [data].[Cluster_Machine_Keys].[Id]

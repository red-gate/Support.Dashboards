...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Agent_Job_Schedule_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Agent_Job_Schedule_StableSamples] ON [data].[Cluster_SqlServer_Agent_Job_Schedule_StableSamples].[Id] = [data].[Cluster_SqlServer_Agent_Job_Keys].[Id]

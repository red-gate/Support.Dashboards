...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Memory_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativePagesInput] AS [Cluster_Machine_Memory_CumulativePagesInput]
, [Leaf].[_CumulativePagesOutput] AS [Cluster_Machine_Memory_CumulativePagesOutput]
, [Leaf].[_FreeBytes] AS [Cluster_Machine_Memory_FreeBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_CumulativePagesInput]
    , [_CumulativePagesOutput]
    , [_FreeBytes]
    FROM [data].[Cluster_Machine_Memory_UnstableSamples]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Process_Sightings_Removable]
(
...
SELECT [data].[Cluster_Machine_Process_Sightings].[SightingDate], [data].[Cluster_Machine_Process_Sightings].[Id]
...
INNER JOIN [data].[Cluster_Machine_Process_Sightings] ON [data].[Cluster_Machine_Process_Sightings].[Id] = [data].[Cluster_Machine_Process_Keys].[Id]

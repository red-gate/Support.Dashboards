...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Error_Instances_TopEvents]
(
    @MinDate AS BIGINT
    , @MaxDate AS BIGINT
...
, [data].[Cluster_SqlServer_Error_Instances].[CollectionDate]
, [utils].[TicksToDateTime]([data].[Cluster_SqlServer_Error_Instances].[CollectionDate]) AS [CollectionDate_DateTime]
, [data].[Cluster_SqlServer_Error_Instances].[_ProcessInfo] AS [Cluster_SqlServer_Error_ProcessInfo]
, [data].[Cluster_SqlServer_Error_Instances].[_Text] AS [Cluster_SqlServer_Error_Text]
FROM [TopInstances]
INNER JOIN [data].[Cluster_SqlServer_Error_Instances]
 ON [TopInstances].[Id] = [data].[Cluster_SqlServer_Error_Instances].[Id]
GO

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Latches_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativeLatchWaits] AS [AzureSqlServer_Database_Latches_CumulativeLatchWaits]
, [Leaf].[_CumulativeLatchWaitTime] AS [AzureSqlServer_Database_Latches_CumulativeLatchWaitTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[AzureSqlServer_Database_Latches_UnstableSamples]

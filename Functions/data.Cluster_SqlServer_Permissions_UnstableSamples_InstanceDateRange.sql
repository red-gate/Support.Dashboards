...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Permissions_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_Data] AS [Cluster_SqlServer_Permissions_Data]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_Data]
    FROM [data].[Cluster_SqlServer_Permissions_UnstableSamples]

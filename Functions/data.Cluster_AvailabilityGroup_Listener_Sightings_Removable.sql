...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Listener_Sightings_Removable]
(
...
SELECT [data].[Cluster_AvailabilityGroup_Listener_Sightings].[SightingDate], [data].[Cluster_AvailabilityGroup_Listener_Sightings].[Id]
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Listener_Sightings] ON [data].[Cluster_AvailabilityGroup_Listener_Sightings].[Id] = [data].[Cluster_AvailabilityGroup_Listener_Keys].[Id]

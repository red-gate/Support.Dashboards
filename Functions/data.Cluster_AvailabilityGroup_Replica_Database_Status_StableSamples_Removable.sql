...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Replica_Database_Status_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Replica_Database_Status_StableSamples] ON [data].[Cluster_AvailabilityGroup_Replica_Database_Status_StableSamples].[Id] = [data].[Cluster_AvailabilityGroup_Replica_Database_Keys].[Id]

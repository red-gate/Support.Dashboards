...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_SqlProcess_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_SqlProcess_UnstableSamples] ON [data].[Cluster_SqlServer_SqlProcess_UnstableSamples].[Id] = [data].[Cluster_SqlServer_SqlProcess_Keys].[Id]

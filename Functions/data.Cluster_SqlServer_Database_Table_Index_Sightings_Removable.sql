...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Table_Index_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Database_Table_Index_Sightings].[SightingDate], [data].[Cluster_SqlServer_Database_Table_Index_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Database_Table_Index_Sightings] ON [data].[Cluster_SqlServer_Database_Table_Index_Sightings].[Id] = [data].[Cluster_SqlServer_Database_Table_Index_Keys].[Id]
 ...
 AND  (@Cluster_SqlServer_Database_Table_Index_Name IS NULL OR [data].[Cluster_SqlServer_Database_Table_Index_Keys].[_Name] = @Cluster_SqlServer_Database_Table_Index_Name)
GO

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_VMware_Processor_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_EffectiveVmSpeedMhz] AS [Cluster_Machine_VMware_Processor_EffectiveVmSpeedMhz]
...
(
    ...
    , [_CpuReservationMhz]
    , [_CpuShares]
    , [_EffectiveVmSpeedMhz]
    , [_HostProcessorSpeedMhz]
    FROM [data].[Cluster_Machine_VMware_Processor_UnstableSamples]

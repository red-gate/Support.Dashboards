...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Network_Capacity_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_Network_Capacity_StableSamples] ON [data].[Cluster_Machine_Network_Capacity_StableSamples].[Id] = [data].[Cluster_Machine_Network_Keys].[Id]

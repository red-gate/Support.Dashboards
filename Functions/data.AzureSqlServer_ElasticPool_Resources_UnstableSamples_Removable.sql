...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_ElasticPool_Resources_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_ElasticPool_Resources_UnstableSamples] ON [data].[AzureSqlServer_ElasticPool_Resources_UnstableSamples].[Id] = [data].[AzureSqlServer_ElasticPool_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples] ON [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples].[Id] = [data].[Cluster_Machine_LogicalDisk_Keys].[Id]

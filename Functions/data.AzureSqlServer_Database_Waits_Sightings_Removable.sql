...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Waits_Sightings_Removable]
(
...
SELECT [data].[AzureSqlServer_Database_Waits_Sightings].[SightingDate], [data].[AzureSqlServer_Database_Waits_Sightings].[Id]
...
INNER JOIN [data].[AzureSqlServer_Database_Waits_Sightings] ON [data].[AzureSqlServer_Database_Waits_Sightings].[Id] = [data].[AzureSqlServer_Database_Waits_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_LogicalDisk_Capacity_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_FreeBytes] AS [Cluster_Machine_LogicalDisk_Capacity_FreeBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_FreeBytes]
    FROM [data].[Cluster_Machine_LogicalDisk_Capacity_UnstableSamples]

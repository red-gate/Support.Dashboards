...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_SqlStatistics_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativeBatchRequests] AS [AzureSqlServer_Database_SqlStatistics_CumulativeBatchRequests]
, [Leaf].[_CumulativeCompilations] AS [AzureSqlServer_Database_SqlStatistics_CumulativeCompilations]
, [Leaf].[_CumulativeRecompilations] AS [AzureSqlServer_Database_SqlStatistics_CumulativeRecompilations]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[AzureSqlServer_Database_SqlStatistics_UnstableSamples]

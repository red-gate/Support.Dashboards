...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Storage_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Storage_UnstableSamples] ON [data].[Cluster_SqlServer_Database_Storage_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]

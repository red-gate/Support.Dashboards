...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_BufferManager_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_BufferCacheHitRatio] AS [AzureSqlServer_Database_BufferManager_BufferCacheHitRatio]
, [Leaf].[_PageLifeExpectancy] AS [AzureSqlServer_Database_BufferManager_PageLifeExpectancy]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_BufferCacheHitRatio]
    , [_PageLifeExpectancy]
    FROM [data].[AzureSqlServer_Database_BufferManager_UnstableSamples]

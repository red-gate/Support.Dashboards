...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_UnstableSamples] ON [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_UnstableSamples].[Id] = [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_Keys].[Id]

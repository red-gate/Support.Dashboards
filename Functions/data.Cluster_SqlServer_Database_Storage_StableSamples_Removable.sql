...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Storage_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Storage_StableSamples] ON [data].[Cluster_SqlServer_Database_Storage_StableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_ClockSkew_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ClockSkew] AS [Cluster_Machine_ClockSkew_ClockSkew]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_ClockSkew]
    FROM [data].[Cluster_Machine_ClockSkew_UnstableSamples]

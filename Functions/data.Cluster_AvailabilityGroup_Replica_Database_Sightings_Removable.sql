...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Replica_Database_Sightings_Removable]
(
...
SELECT [data].[Cluster_AvailabilityGroup_Replica_Database_Sightings].[SightingDate], [data].[Cluster_AvailabilityGroup_Replica_Database_Sightings].[Id]
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Replica_Database_Sightings] ON [data].[Cluster_AvailabilityGroup_Replica_Database_Sightings].[Id] = [data].[Cluster_AvailabilityGroup_Replica_Database_Keys].[Id]
 ...
 AND  (@Cluster_AvailabilityGroup_Replica_Database_Name IS NULL OR [data].[Cluster_AvailabilityGroup_Replica_Database_Keys].[_Name] = @Cluster_AvailabilityGroup_Replica_Database_Name)
GO

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_UnstableSamples] ON [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_UnstableSamples].[Id] = [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_VMware_StableSamples_Purgeable]
(
    @PurgeDate AS BIGINT
)
RETURNS TABLE
    ...
    (
        ...
        SELECT
            ...
            (
                ...
                FROM [data].[Cluster_Machine_VMware_StableSamples] [Dates]
...
INNER JOIN [data].[Cluster_Machine_VMware_StableSamples] ON [data].[Cluster_Machine_VMware_StableSamples].[Id] = [SightedIdsWithLastDates].[Id]
WHERE [data].[Cluster_Machine_VMware_StableSamples].[CollectionDate] < [SightedIdsWithLastDates].[LastDate]
GO

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_LogicalDisk_Capacity_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_LogicalDisk_Capacity_UnstableSamples] ON [data].[Cluster_Machine_LogicalDisk_Capacity_UnstableSamples].[Id] = [data].[Cluster_Machine_LogicalDisk_Keys].[Id]

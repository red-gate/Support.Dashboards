...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Listener_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Listener_StableSamples] ON [data].[Cluster_AvailabilityGroup_Listener_StableSamples].[Id] = [data].[Cluster_AvailabilityGroup_Listener_Keys].[Id]

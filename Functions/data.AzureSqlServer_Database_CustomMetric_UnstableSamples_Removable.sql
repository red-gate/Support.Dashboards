...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_CustomMetric_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_CustomMetric_UnstableSamples] ON [data].[AzureSqlServer_Database_CustomMetric_UnstableSamples].[Id] = [data].[AzureSqlServer_Database_CustomMetric_Keys].[Id]

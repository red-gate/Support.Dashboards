...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Sightings_Removable]
(
...
SELECT [data].[Cluster_Machine_Sightings].[SightingDate], [data].[Cluster_Machine_Sightings].[Id]
FROM [data].[Cluster_Keys]
INNER JOIN [data].[Cluster_Machine_Keys] ON [data].[Cluster_Machine_Keys].[ParentId] = [data].[Cluster_Keys].[Id]
INNER JOIN [data].[Cluster_Machine_Sightings] ON [data].[Cluster_Machine_Sightings].[Id] = [data].[Cluster_Machine_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Storage_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_Storage_StableSamples] ON [data].[AzureSqlServer_Database_Storage_StableSamples].[Id] = [data].[AzureSqlServer_Database_Keys].[Id]

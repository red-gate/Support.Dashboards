...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_StableSamples] ON [data].[Cluster_SqlServer_Database_StableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_File_Projection_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_File_Projection_UnstableSamples] ON [data].[Cluster_SqlServer_Database_File_Projection_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_File_Keys].[Id]

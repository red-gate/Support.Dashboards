...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Storage_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_DatabaseUsedSizeInBytes] AS [AzureSqlServer_Database_Storage_DatabaseUsedSizeInBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_DatabaseUsedSizeInBytes]
    FROM [data].[AzureSqlServer_Database_Storage_UnstableSamples]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Performance_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_Performance_UnstableSamples] ON [data].[AzureSqlServer_Database_Performance_UnstableSamples].[Id] = [data].[AzureSqlServer_Database_Keys].[Id]

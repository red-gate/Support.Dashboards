...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_StableSamples] ON [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_StableSamples].[Id] = [data].[Cluster_SqlServer_TopQueries_QueryWaitStats_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_GeneralStatistics_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_UserConnections] AS [AzureSqlServer_Database_GeneralStatistics_UserConnections]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_UserConnections]
    FROM [data].[AzureSqlServer_Database_GeneralStatistics_UnstableSamples]

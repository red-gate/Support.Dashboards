...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Resources_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_MaxSessionPercent] AS [AzureSqlServer_Database_Resources_MaxSessionPercent]
, [Leaf].[_MaxWorkerPercent] AS [AzureSqlServer_Database_Resources_MaxWorkerPercent]
, [Leaf].[_PercentCpu] AS [AzureSqlServer_Database_Resources_PercentCpu]
, [Leaf].[_PercentIo] AS [AzureSqlServer_Database_Resources_PercentIo]
, [Leaf].[_PercentLogWrite] AS [AzureSqlServer_Database_Resources_PercentLogWrite]
, [Leaf].[_PercentMemoryUsed] AS [AzureSqlServer_Database_Resources_PercentMemoryUsed]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_PercentLogWrite]
    , [_PercentMemoryUsed]
    FROM [data].[AzureSqlServer_Database_Resources_UnstableSamples]

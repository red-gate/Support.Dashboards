...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Cluster_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_Cluster_StableSamples] ON [data].[Cluster_Machine_Cluster_StableSamples].[Id] = [data].[Cluster_Machine_Keys].[Id]

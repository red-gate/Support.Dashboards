...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Network_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_Network_UnstableSamples] ON [data].[Cluster_Machine_Network_UnstableSamples].[Id] = [data].[Cluster_Machine_Network_Keys].[Id]

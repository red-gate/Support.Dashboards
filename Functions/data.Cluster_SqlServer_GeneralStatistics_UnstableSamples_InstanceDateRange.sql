...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_GeneralStatistics_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_UserConnections] AS [Cluster_SqlServer_GeneralStatistics_UserConnections]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_UserConnections]
    FROM [data].[Cluster_SqlServer_GeneralStatistics_UnstableSamples]

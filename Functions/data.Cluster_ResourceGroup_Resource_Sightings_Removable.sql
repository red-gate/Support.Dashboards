...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_ResourceGroup_Resource_Sightings_Removable]
(
...
SELECT [data].[Cluster_ResourceGroup_Resource_Sightings].[SightingDate], [data].[Cluster_ResourceGroup_Resource_Sightings].[Id]
...
INNER JOIN [data].[Cluster_ResourceGroup_Resource_Sightings] ON [data].[Cluster_ResourceGroup_Resource_Sightings].[Id] = [data].[Cluster_ResourceGroup_Resource_Keys].[Id]

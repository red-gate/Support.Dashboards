...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_CustomMetric_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_CustomMetric_StableSamples] ON [data].[AzureSqlServer_Database_CustomMetric_StableSamples].[Id] = [data].[AzureSqlServer_Database_CustomMetric_Keys].[Id]

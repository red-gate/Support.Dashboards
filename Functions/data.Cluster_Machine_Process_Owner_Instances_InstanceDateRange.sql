...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Process_Owner_Instances_InstanceDateRange]
(
...
, [utils].[TicksToDateTime]([SightedInstances].[Cluster_Machine_Process_StartDate]) AS [Cluster_Machine_Process_Owner_StartDate_DateTime]
, [Leaf].[CollectionDate]
, [utils].[TicksToDateTime]([Leaf].[CollectionDate]) AS [CollectionDate_DateTime]
, [Leaf].[_Domain] AS [Cluster_Machine_Process_Owner_Domain]
, [Leaf].[_User] AS [Cluster_Machine_Process_Owner_User]
FROM
 [SightedInstances]
INNER JOIN
 [data].[Cluster_Machine_Process_Owner_Instances] [Leaf]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Replica_Info_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Replica_Info_StableSamples] ON [data].[Cluster_AvailabilityGroup_Replica_Info_StableSamples].[Id] = [data].[Cluster_AvailabilityGroup_Replica_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Table_Index_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Table_Index_UnstableSamples] ON [data].[Cluster_SqlServer_Database_Table_Index_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_Table_Index_Keys].[Id]

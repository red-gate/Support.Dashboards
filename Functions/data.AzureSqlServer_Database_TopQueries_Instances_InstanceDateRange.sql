...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_TopQueries_Instances_InstanceDateRange]
(
...
, [Leaf].[_QueryText] AS [AzureSqlServer_Database_TopQueries_QueryText]
FROM
 [SightedInstances]
INNER JOIN
 [data].[AzureSqlServer_Database_TopQueries_Instances] [Leaf]

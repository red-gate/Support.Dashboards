...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Database_Sightings].[SightingDate], [data].[Cluster_SqlServer_Database_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Database_Sightings] ON [data].[Cluster_SqlServer_Database_Sightings].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]

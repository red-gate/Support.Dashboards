...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_AccessMethods_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativeFullScans] AS [AzureSqlServer_Database_AccessMethods_CumulativeFullScans]
, [Leaf].[_CumulativePageSplits] AS [AzureSqlServer_Database_AccessMethods_CumulativePageSplits]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[AzureSqlServer_Database_AccessMethods_UnstableSamples]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_LogicalDisk_Sightings_Removable]
(
...
SELECT [data].[Cluster_Machine_LogicalDisk_Sightings].[SightingDate], [data].[Cluster_Machine_LogicalDisk_Sightings].[Id]
...
INNER JOIN [data].[Cluster_Machine_LogicalDisk_Sightings] ON [data].[Cluster_Machine_LogicalDisk_Sightings].[Id] = [data].[Cluster_Machine_LogicalDisk_Keys].[Id]

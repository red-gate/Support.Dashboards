...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_TopQueries_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_TopQueries_UnstableSamples] ON [data].[AzureSqlServer_Database_TopQueries_UnstableSamples].[Id] = [data].[AzureSqlServer_Database_TopQueries_Keys].[Id]

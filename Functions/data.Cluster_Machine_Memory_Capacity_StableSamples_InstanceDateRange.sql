...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Memory_Capacity_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalBytes] AS [Cluster_Machine_Memory_Capacity_TotalBytes]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_Memory_Capacity_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_Memory_Capacity_StableSamples] [Leaf]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_QueryPlans_Sightings_Removable]
(
...
SELECT [data].[AzureSqlServer_Database_QueryPlans_Sightings].[SightingDate], [data].[AzureSqlServer_Database_QueryPlans_Sightings].[Id]
...
INNER JOIN [data].[AzureSqlServer_Database_QueryPlans_Sightings] ON [data].[AzureSqlServer_Database_QueryPlans_Sightings].[Id] = [data].[AzureSqlServer_Database_QueryPlans_Keys].[Id]

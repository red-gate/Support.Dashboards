...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Performance_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ActiveTransactions] AS [AzureSqlServer_Database_Performance_ActiveTransactions]
, [Leaf].[_CumulativeLogBytesFlushed] AS [AzureSqlServer_Database_Performance_CumulativeLogBytesFlushed]
, [Leaf].[_CumulativeLogFlushes] AS [AzureSqlServer_Database_Performance_CumulativeLogFlushes]
, [Leaf].[_CumulativeLogFlushWaits] AS [AzureSqlServer_Database_Performance_CumulativeLogFlushWaits]
, [Leaf].[_CumulativeTransactions] AS [AzureSqlServer_Database_Performance_CumulativeTransactions]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[AzureSqlServer_Database_Performance_UnstableSamples]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_AvailabilityGroup_Replica_Performance_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_AvailabilityGroup_Replica_Performance_UnstableSamples] ON [data].[Cluster_AvailabilityGroup_Replica_Performance_UnstableSamples].[Id] = [data].[Cluster_AvailabilityGroup_Replica_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Latches_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativeLatchWaits] AS [Cluster_SqlServer_Latches_CumulativeLatchWaits]
, [Leaf].[_CumulativeLatchWaitTime] AS [Cluster_SqlServer_Latches_CumulativeLatchWaitTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[Cluster_SqlServer_Latches_UnstableSamples]

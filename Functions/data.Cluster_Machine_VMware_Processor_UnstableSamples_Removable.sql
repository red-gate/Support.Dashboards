...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_VMware_Processor_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_Machine_VMware_Processor_UnstableSamples] ON [data].[Cluster_Machine_VMware_Processor_UnstableSamples].[Id] = [data].[Cluster_Machine_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_TimeZone_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_TimeZoneInfo] AS [Cluster_Machine_TimeZone_TimeZoneInfo]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_TimeZone_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_TimeZone_StableSamples] [Leaf]

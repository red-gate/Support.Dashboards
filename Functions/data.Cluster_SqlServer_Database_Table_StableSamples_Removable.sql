...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Table_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Table_StableSamples] ON [data].[Cluster_SqlServer_Database_Table_StableSamples].[Id] = [data].[Cluster_SqlServer_Database_Table_Keys].[Id]

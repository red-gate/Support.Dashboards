...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Sightings_Removable]
(
...
SELECT [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Sightings].[SightingDate], [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Sightings].[Id]
...
INNER JOIN [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Sightings] ON [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Sightings].[Id] = [data].[AzureSqlServer_Database_TopQueries_QueryWaitStats_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Cluster_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_State] AS [Cluster_Machine_Cluster_State]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_Cluster_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_Cluster_StableSamples] [Leaf]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_TopQueries_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TopQueries_StableSamples] ON [data].[Cluster_SqlServer_TopQueries_StableSamples].[Id] = [data].[Cluster_SqlServer_TopQueries_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Ping_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_RoundtripTime] AS [Cluster_SqlServer_Ping_RoundtripTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_RoundtripTime]
    FROM [data].[Cluster_SqlServer_Ping_UnstableSamples]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_VolumePath] AS [Cluster_Machine_LogicalDisk_Volume_VolumePath]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_LogicalDisk_Volume_StableSamples] [Leaf]

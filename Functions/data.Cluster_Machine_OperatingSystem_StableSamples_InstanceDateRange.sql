...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_OperatingSystem_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_BuildNumber] AS [Cluster_Machine_OperatingSystem_BuildNumber]
, [Leaf].[_Caption] AS [Cluster_Machine_OperatingSystem_Caption]
, [Leaf].[_ServicePack] AS [Cluster_Machine_OperatingSystem_ServicePack]
, [Leaf].[_Version] AS [Cluster_Machine_OperatingSystem_Version]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_OperatingSystem_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_OperatingSystem_StableSamples] [Leaf]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Storage_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalDataUsedBytes] AS [Cluster_SqlServer_Database_Storage_TotalDataUsedBytes]
, [Leaf].[_TotalLogUsedBytes] AS [Cluster_SqlServer_Database_Storage_TotalLogUsedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_TotalDataUsedBytes]
    , [_TotalLogUsedBytes]
    FROM [data].[Cluster_SqlServer_Database_Storage_UnstableSamples]

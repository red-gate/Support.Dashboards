...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_Resources_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_DtuLimit] AS [AzureSqlServer_Database_Resources_DtuLimit]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[AzureSqlServer_Database_Resources_StableSamples]
...
INNER JOIN
 [data].[AzureSqlServer_Database_Resources_StableSamples] [Leaf]

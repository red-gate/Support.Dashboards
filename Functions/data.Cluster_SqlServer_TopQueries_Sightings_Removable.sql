...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_TopQueries_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_TopQueries_Sightings].[SightingDate], [data].[Cluster_SqlServer_TopQueries_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_TopQueries_Sightings] ON [data].[Cluster_SqlServer_TopQueries_Sightings].[Id] = [data].[Cluster_SqlServer_TopQueries_Keys].[Id]

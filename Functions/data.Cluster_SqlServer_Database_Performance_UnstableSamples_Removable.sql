...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_Performance_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Performance_UnstableSamples] ON [data].[Cluster_SqlServer_Database_Performance_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Services_Sightings_Removable]
(
...
SELECT [data].[Cluster_Machine_Services_Sightings].[SightingDate], [data].[Cluster_Machine_Services_Sightings].[Id]
...
INNER JOIN [data].[Cluster_Machine_Services_Sightings] ON [data].[Cluster_Machine_Services_Sightings].[Id] = [data].[Cluster_Machine_Services_Keys].[Id]

...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_Machine_Properties_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_DnsHostName] AS [Cluster_Machine_Properties_DnsHostName]
, [Leaf].[_Domain] AS [Cluster_Machine_Properties_Domain]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_Properties_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_Properties_StableSamples] [Leaf]

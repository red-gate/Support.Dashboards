...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Permissions_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Permissions_UnstableSamples] ON [data].[Cluster_SqlServer_Permissions_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Keys].[Id]

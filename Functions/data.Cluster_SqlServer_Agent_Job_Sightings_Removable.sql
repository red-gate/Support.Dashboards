...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Agent_Job_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Agent_Job_Sightings].[SightingDate], [data].[Cluster_SqlServer_Agent_Job_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Agent_Job_Sightings] ON [data].[Cluster_SqlServer_Agent_Job_Sightings].[Id] = [data].[Cluster_SqlServer_Agent_Job_Keys].[Id]

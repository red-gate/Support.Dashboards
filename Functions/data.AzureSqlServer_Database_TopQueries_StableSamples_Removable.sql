...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[AzureSqlServer_Database_TopQueries_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_TopQueries_StableSamples] ON [data].[AzureSqlServer_Database_TopQueries_StableSamples].[Id] = [data].[AzureSqlServer_Database_TopQueries_Keys].[Id]

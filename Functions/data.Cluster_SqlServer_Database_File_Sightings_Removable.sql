...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [data].[Cluster_SqlServer_Database_File_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Database_File_Sightings].[SightingDate], [data].[Cluster_SqlServer_Database_File_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Database_File_Sightings] ON [data].[Cluster_SqlServer_Database_File_Sightings].[Id] = [data].[Cluster_SqlServer_Database_File_Keys].[Id]

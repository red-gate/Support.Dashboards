...
GO
ALTER TABLE [settings].[AzureSqlServers] ADD CONSTRAINT [AzureSqlServers_Id] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
ALTER TABLE [settings].[AzureSqlServers] ADD CONSTRAINT [AzureSqlServers_Name] UNIQUE NONCLUSTERED  ([Name]) ON [PRIMARY]
GO

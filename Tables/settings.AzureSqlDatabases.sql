...
GO
ALTER TABLE [settings].[AzureSqlDatabases] ADD CONSTRAINT [AzureSqlDatabases_Id] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
ALTER TABLE [settings].[AzureSqlDatabases] ADD CONSTRAINT [AzureSqlDatabases_ParentId_Name] UNIQUE NONCLUSTERED  ([ParentId], [Name]) ON [PRIMARY]
GO
ALTER TABLE [settings].[AzureSqlDatabases] ADD CONSTRAINT [AzureSqlDatabases_Clusters] FOREIGN KEY ([ParentId]) REFERENCES [settings].[AzureSqlServers] ([Id]) ON DELETE CASCADE
GO
